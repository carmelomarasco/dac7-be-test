...
/**
 * The primary key class for the POTENTIAL_DEST_DELETED database table.
 *
 */
@Embeddable
public class PotentialDestDeletedPK implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof PotentialDestDeletedPK)) {
            return false;
        }
        PotentialDestDeletedPK castOther = (PotentialDestDeletedPK)other;
        return
